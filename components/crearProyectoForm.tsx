...
const CrearProyectoForm = ({isOpen, onClose, guardarDatos} : any) => {
    ...
    <div className='modal-container' style={{ display: isOpen ? 'grid': 'none'}}> 
      <div className='modal-body'>
        ...
        <div className="input-group mb-3">
            <span className="input-group-text" id="inputGroup-sizing-default">Nombre del Proyecto</span>
            <input 
            onChange={(event)=>{
        ...
        <div className="input-group mb-3">
            <label className="input-group-text">Lider del Proyecto</label>
